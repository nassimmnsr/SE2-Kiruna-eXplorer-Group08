  ...
  const documents = [
    {
      ...
      stakeholders: ["Residents", "Kiruna Municipality"],
      scale: "Regional",
    ...
    },
    {
      ...
      language: "Spanish",
      nr_pages: "",
      geolocation: "Kiruna municpiality",
    ...
    },
    {
      ...
      description:
        "Strategies to boost economic growth in the metropolitan area.",
    },
    {
      id: 4,
    ...
    },
    {
      ...
      description:
        "Blueprint for digital transformation in public administration.",
    },
    {
      id: 8,
